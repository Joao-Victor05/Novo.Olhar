...
const MapaInterativo = () => {
  ...
  const locations = [
    {
      ...
      category: 'eventos',
      address: 'Av. Nossa Senhora dos Navegantes, 675 - Enseada do Suá, Vitória - ES',
      description: 'Centro de apoio ao empreendedorismo capixaba com eventos e capacitações',
    ...
    },
    {
      ...
      description: 'Principal universidade pública do estado com diversos cursos de extensão',
    ...
    },
    {
      ...
      category: 'saude',
      address: 'R. Dr. João Batista Miranda Amaral, 267 - Nazareth, Vitória - ES',
    ...
    },
    {
      ...
      category: 'eventos',
      address: 'Av. Luciano das Neves, 2418 - Divino Espírito Santo, Vila Velha - ES',
    ...
    },
    {
      ...
      category: 'cursos',
      address: 'R. Orlando Damasceno Ferreira, 405 - Jardim da Penha, Vitória - ES',
    ...
    },
    {
      ...
      description: 'Centro de relacionamento empresarial e desenvolvimento industrial',
    ...
    },
    {
      ...
      category: 'eventos',
      address: 'Av. Francisco Lacerda de Aguiar, 200 - Guandu, Cachoeiro de Itapemirim - ES',
  ...
  useEffect(() => {
    ...
    mapRef.current = L.map(mapContainerRef.current).setView([-20.2976, -40.2958], 10);
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Descubra oportunidades de crescimento profissional e empresarial no estado do Espírito Santo. 
              Conecte-se com instituições, eventos e recursos da sua região.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <p className="text-purple-100">
                Encontre instituições e eventos em todo o estado do Espírito Santo
              </p>
            </div>
